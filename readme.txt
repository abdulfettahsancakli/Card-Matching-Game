...
I created a 2-dimensional array in the Mix function and made the array elements in the form of this because the id field contains the image information in src to find the position of the image on The Matrix and src to check it.
 ...
 I created an infinite loop while so that these numbers do not repeat,
 then I sorted it by id with the function" sort " and placed it in the 2-dimensional 4x4 array mentioned in the press with a nested for loop.
...
3. Finally, in Phase 3, I placed the show all button to show the random distribution of the pictures.
